...
from digimon_card_game.cards.information import (
    CardColor,
    CardRarity,
    DigimonForm,
    DigimonAttribute,
...
from .assertions import (
    ...
    assert_frozenset_raises_not_minimum_length,
)
...
def test_01_name_must_not_be_blank() -> None:
    assert_attr_raises_not_blank(
        "name",
        lambda invalid_name: DigimonCard(
            name=invalid_name,
            colors=colors,
            identifier="ST1-02",
...
def test_02_identifier_must_not_be_blank() -> None:
    assert_attr_raises_not_blank(
        "identifier",
        lambda invalid_identifier: DigimonCard(
            name="Biyomon",
            colors=colors,
...
def test_03_cost_must_be_between_zero_and_twenty() -> None:
    assert_attr_raises_not_within_range(
        ...
        0,
        20,
        lambda invalid_cost: DigimonCard(
            name="Biyomon",
            colors=colors,
            identifier="ST1-02",
            rarity=CardRarity.COMMON,
...
def test_04_power_must_be_positive() -> None:
    assert_attr_raises_not_positive(
        "power",
        lambda invalid_power: DigimonCard(
            name="Biyomon",
            colors=colors,
            identifier="ST1-02",
            rarity=CardRarity.COMMON,
...
def test_05_level_must_be_between_two_and_seven() -> None:
    assert_attr_raises_not_within_range(
        ...
        2,
        7,
        lambda invalid_level: DigimonCard(
            name="Biyomon",
            colors=colors,
            identifier="ST1-02",
            rarity=CardRarity.COMMON,
...
def test_07_cannot_create_card_without_color() -> None:
    assert_frozenset_raises_not_minimum_length(
        "colors",
        1,
        lambda invalid_colors: DigimonCard(
            name="Biyomon",
            colors=invalid_colors,
            identifier="ST1-02",
            rarity=CardRarity.COMMON,
...
def test_09_cannot_create_card_without_types() -> None:
    assert_frozenset_raises_not_minimum_length(
        "types",
        1,
        lambda invalid_types: DigimonCard(
            name="Biyomon",
            colors=colors,
            identifier="ST1-02",
            rarity=CardRarity.COMMON,
...
def test_11_instance_creation_without_level() -> None:
    card_without_level = DigimonCard(
        name="Biyomon",
        colors=colors,
        identifier="ST1-02",
        rarity=CardRarity.COMMON,
