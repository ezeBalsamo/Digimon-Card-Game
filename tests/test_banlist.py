...
def test_05_card_is_allowed_when_is_in_the_banlist_and_number_of_copies_is_lower_than_the_allowed() -> None:
...
def test_06_card_is_allowed_when_is_in_the_banlist_and_number_of_copies_equals_the_allowed() -> None:
    number_of_copies_by_card = {shadow_wing: 3}
    banlist = Banlist(date=date.today(), number_of_copies_by_card=number_of_copies_by_card)
...
def test_07_card_is_not_allowed_when_is_in_the_banlist_and_number_of_copies_is_greater_than_the_allowed() -> None:
    number_of_copies_by_card = {biyomon: 0}
    banlist = Banlist(date=date.today(), number_of_copies_by_card=number_of_copies_by_card)
...
def test_11_deckset_is_not_allowed_if_at_least_one_the_optional_decks_is_not_allowed() -> None:
    number_of_copies_by_card = {
        shadow_wing: 3,
        biyomon: 0
    }
