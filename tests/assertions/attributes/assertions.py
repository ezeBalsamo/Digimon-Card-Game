...
def assert_attr_raises_not_within_range(attr_name: str, lower: int, upper: int, closure: Callable[[int], Any]) -> None:
...
def assert_attr_raises_not_positive(attr_name: str, closure: Callable[[int], Any]) -> None:
